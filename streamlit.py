...
if st.session_state.page == "app":
    ...
    st.markdown(
    f"""
    <div style='background:#e8f4fd;border-radius:10px;padding:12px 18px;
                border-left:4px solid #4a90d9;margin-bottom:10px;'>
        <span style='font-size:12px;font-weight:700;color:#4a90d9;
                     text-transform:uppercase;letter-spacing:1px;'>
            🌟 Daily Inspiration
        </span><br>
        <span style='font-size:15px;color:#222;font-style:italic;'>
