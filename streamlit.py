...
#     st.subheader("Turning everyday objects into acts of kindness")

#     st.markdown("""
#     **Westport Smiles** is a kid-friendly AI app that helps people discover
#     simple and meaningful ways to spread kindness using everyday objects.
...
#     # -------- App Page Header with Logo --------
#     col_left, col_right = st.columns([4, 1])

#     with col_right:
#         st.image(
#             "kindness_logo.png",  # <-- your logo file name
#             width=120
#         )
...
#             st.subheader(f"🧠 Object: {data['object']}")
#             st.subheader("🌟 Kindness Ideas")

#             for idea in data["ideas"].split("\n"):
#                 if idea.strip():
#                     st.write("•", idea)
...
#     st.markdown("Watch how Westport Smiles works:")
...
#     st.markdown("""
#     Here are some helpful resources related to kindness, AI, and learning:
...
if st.session_state.page == "video":
    ...
    st.markdown(
        """
        <iframe 
            src="https://drive.google.com/file/d/1_EuKavL2ubqPO3orXCZo-tUYOCKQXm97/preview"
            width="100%"
            height="480"
            allow="autoplay">
        </iframe>
